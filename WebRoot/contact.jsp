	...
	<div id="templatemo_content">
    	...
    	<div id="templatemo_main_leftcol">
        	<div class="templatemo_leftcol_subcol">
            	...
            	<div id="templatemo_topnews">
                    <h4><strong>Application Developers:</strong></h4></br>
                    <h2>
                    <p><strong>Regaig Anis:</strong> <a href="mailto:anis.regaieg@gmail.com">anis.regaieg@gmail.com</a></p></br>
                    <p><strong>Alibi Mohamed:</strong> <a href="mailto:alibimohamed@gmail.com">alibimohamed@gmail.com</a></p></br>
                    </h2>
            	</div>
      ...
      <div id="templatemo_main_rightcol">
        	<div class="templatemo_rcol_sectionwithborder">
                ...
                <h2>Projet Localisateur de BTS</h2>
                <h2><img src="images/bts.jpg" alt="image" width="350" height="424" /></h2>
           	  </div>
            </div>
      </div>
    </div>
