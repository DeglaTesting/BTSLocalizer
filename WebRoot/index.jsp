...
<div id="templatemo_container">
    ...
    <div id="templatemo_menu">
        <ul>
            <li><a href="index.jsp"  class="current">Accueil</a></li>
            <li><a href="map.jsp">MAP Des BTS</a></li>
            <li><a href="addbts.jsp">Ajouter de nouveaux BTS</a></li>  
	...
	<div id="templatemo_content">
    	...
    	<div id="templatemo_main_leftcol">
        	<div class="templatemo_leftcol_subcol">
            	...
            	<div id="templatemo_topnews">
                    <h2>Installation des antennes BTS:</h2>
                    <p><img src="images/img01.jpg" alt="image" width="282" height="200" />
                    </p>
                    <h2>Emplacement des antenne BTS</h2>
                    
           	      
                  <img src="images/img09.jpg" alt="image" width="277" height="195" />
            	</div>
        	</div> <!-- end of left column -->
        	
            <div class="templatemo_leftcol_subcol">
				<div class="regular_section">
                    <h2>Equipement BTS:</h2>
					
					  <p><img src="images/img05.jpg" alt="image" width="276" height="207" /></p>
					  <h2>Reseaux filaire des BTS:</h2></br>
				      					  
                      <p><img src="images/img10.png" alt="image" width="278" height="211" /></p>
      ...
      <div id="templatemo_main_rightcol">
        	<div class="templatemo_rcol_sectionwithborder">
                ...
                <h2>Couvergence de reseaux BTS:</h2>
                
                <img src="images/img07.gif" alt="image" width="348" height="293" />
